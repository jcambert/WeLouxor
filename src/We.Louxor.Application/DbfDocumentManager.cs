...
internal static class LoggerColor
{
    ...
    public static string FormatColor(this string s) => $"{BACKGROUND_COLOR}{s}{DEFAULT_COLOR}";

    public static string FormatWarning(this string s) => $"{BACKGROUND_WARNING}{s}{DEFAULT_COLOR}";
}
...
public sealed class DbfDocumentManager : DomainService
{
    ...
    private void Initialize()
    {
        ...
        Doc.FieldsDescriptorLoaded.Subscribe(
            fields =>
            {
        ...
        Doc.AllRecordsLoaded.Subscribe(
            b =>
            {
