...
namespace We.Louxor.Migrations
{
    ...
    public partial class Cdeaddcodcli : Migration
    {
        ...
        {
            migrationBuilder.DropColumn(name: "CodeClient", table: "LouxorInv_lignedecommande");

            migrationBuilder.DropColumn(name: "ArticleDeTeteId", table: "LignesInventaires");

            migrationBuilder.DropColumn(name: "ArticleId", table: "LignesInventaires");

            migrationBuilder.DropColumn(name: "PuGamme", table: "LignesInventaires");
