...
namespace We.Louxor.Migrations
{
    ...
    public partial class Initial : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        CoutMatiereDirect = table.Column<double>(
                            type: "double precision",
                            nullable: false
                        ),
                        CoutMachineDirect = table.Column<double>(
                            type: "double precision",
                            nullable: false
                        ),
                        ExtraProperties = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        PrixUnitaire = table.Column<double>(
                            type: "double precision",
                            nullable: false
                        ),
                        QuantiteCommande = table.Column<double>(
                            type: "double precision",
                            nullable: false
                        ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "LignesInventaires");

            migrationBuilder.DropTable(name: "LouxorInv_article");

            migrationBuilder.DropTable(name: "LouxorInv_lignedecommande");
