...
public class LouxorDbMigrationService : ITransientDependency
{
    public ILogger<LouxorDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<ILouxorDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public LouxorDbMigrationService(
    ...
    )
    {
        ...
        Logger = NullLogger<LouxorDbMigrationService>.Instance;
    }
